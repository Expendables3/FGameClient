package Event.EventNoel.NoelGui.ItemGui 
{
	 ...
	 * @author HiepNM2
	 */
	public class EffGunFire extends SwfEffect 
	{
		private const FRAME_JOIN:int = 4;
		private var joined:Boolean = false;
		public var funcJoin:Function = null;
		public function EffGunFire(parent:Object, swfName:String, ChildList:Array=null, x:Number=0, y:Number=0, ReUse:Boolean=false, IsLoop:Boolean=false, ObjUse:BaseObject=null, f:Function=null) 
		{
