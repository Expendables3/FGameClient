package GUI.EventEuro 
{
	 ...
	 * @author dongtq
	 */
	public class GUIChooseElementEuro extends BaseGUI
	{
		private var okFunction:Function;
		static public const BTN_CLOSE:String = "btnClose";
		static public const ELEMENT:String = "element";
		
		public function GUIChooseElementEuro(parent:Object, imgName:String, x:int = 0, y:int = 0, isLinkAge:Boolean = true, imgAlign:String = ALIGN_LEFT_TOP) 
		{
