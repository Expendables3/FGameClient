package GUI.Tournament 
{
	 ...
	 * @author MinhT
	 */
	public class GUITournamentCongratChampion extends BaseGUI 
	{
		...
		public function GUITournamentCongratChampion(parent:Object, imgName:String, x:int=0, y:int=0, isLinkAge:Boolean=true, imgAlign:String=ALIGN_LEFT_TOP) 
		{
			super(parent, imgName, x, y, isLinkAge, imgAlign);
			this.ClassName = "GUITournamentCongratChampion";
		}
		...
		public override function InitGUI() :void
		{
			this.setImgInfo = function():void
			{
				...
				fm.bold = true;
				fm.size = 24;
				var st:String = Localization.getInstance().getString("tourNumChoose");
				st = st.replace("@max", maxChoose);
				AddLabel(st, 269, 190, 0, 0).setTextFormat(fm);
				
				OpenRoomOut();
			}
			
			LoadRes("GuiTournament_CongratChampion");
		}
		
		private function setStarByResult():void 
		{
